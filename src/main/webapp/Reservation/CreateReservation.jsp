<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <% String username=(String) session.getAttribute("username"); String role=(String) session.getAttribute("role"); if
        (username==null) { response.sendRedirect(request.getContextPath() + "/Auth/Login.jsp" ); return; } %>
        <!DOCTYPE html>
        <html lang="en">
                                            ...
                                            <form action="${pageContext.request.contextPath}/reservation-servlet"
                                                ...
                                                <div class="form-grid">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="reservationNo" class="form-input"
                                                            value="" readonly
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="room_type_id" class="form-select"
                                                                ...
                                                                <option value="3" data-price="200" data-name="Suite">
                                                                    Suite -
                                                                    $200/night</option>
