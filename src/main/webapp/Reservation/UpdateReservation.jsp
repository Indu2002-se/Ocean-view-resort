            ...
            <body>
                ...
                <aside class="sidebar" id="sidebar">
                    ...
                    <nav class="sidebar-menu">
                        <div class="menu-section">
                            ...
                            <a href="${pageContext.request.contextPath}/reservation-servlet" class="menu-item active">
                                <span class="menu-icon">📅</span>
                ...
                <main class="main-content">
                    <div class="reservation-container">
                        <% Reservation reservation=(Reservation) request.getAttribute("reservation"); DateTimeFormatter
                            dateFormatter=DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm"); %>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="room_type_id" class="form-select"
                                                                        ...
                                                                        <option value="1" data-price="80"
                                                                            data-name="Standard Room" <%=(reservation
                                                                            !=null && reservation.getRoomTypeId()==1)
                                                                            ? "selected" : "" %>>Standard Room -
                                                                            $80/night</option>
                                                                        <option value="2" data-price="120"
                                                                            data-name="Deluxe Room" <%=(reservation
                                                                            !=null && reservation.getRoomTypeId()==2)
                                                                            ? "selected" : "" %>>Deluxe Room -
                                                                            $120/night</option>
                                                                        <option value="3" data-price="200"
                                                                            data-name="Suite" <%=(reservation !=null &&
                                                                            reservation.getRoomTypeId()==3) ? "selected"
                                                                            : "" %>>Suite - $200/night
                                                                        </option>
                                                                        <option value="4" data-price="250"
                                                                            data-name="Ocean View Suite" <%=(reservation
                                                                            !=null && reservation.getRoomTypeId()==4)
                                                                            ? "selected" : "" %>>Ocean View
