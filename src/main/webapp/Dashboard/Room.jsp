...
<body>
    ...
    <div class="main-content">
        <nav class="top-nav">
            ...
            <ul class="nav-menu">
                ...
                <li><a href="${pageContext.request.contextPath}/Dashboard/StaffDashboard.jsp">Dashboard</a></li>
                <li><a href="${pageContext.request.contextPath}/reservation-servlet">Reservations</a></li>
                <li><a href="#" class="active">Rooms</a></li>
                <li><a href="${pageContext.request.contextPath}/bill-servlet">Billing</a></li>
            </ul>
        </nav>
        ...
        <div class="room-container">
            <div class="page-header">
                ...
                <p class="page-description">
                    Manage all rooms at Ocean View Resort. View room status, update information, and maintain room inventory.
                </p>
            </div>
            ...
            <div class="rooms-grid" id="roomsGrid">
                ...
                %>
                    <div class="room-card" data-room-number="<%= room.getRoomNumber() %>" data-status="<%= room.getStatus() %>">
                        ...
                        <div class="room-body">
                            <div class="room-info">
                                ...
                                <div class="info-row">
                                    ...
                                    <span class="info-value"><%= room.getRoomTypeId() %></span>
                                </div>
                                <div class="info-row">
                            ...
                            <div class="room-actions">
                                <button class="btn-action btn-edit" onclick="openEditModal(<%= room.getRoomId() %>, '<%= room.getRoomNumber() %>', <%= room.getRoomTypeId() %>, '<%= room.getStatus() %>')">
                                    ✏️ Edit
                                </button>
                                <button class="btn-action btn-delete" onclick="confirmDelete(<%= room.getRoomId() %>, '<%= room.getRoomNumber() %>')">
                                    🗑️ Delete
                                </button>
                            </div>
                        </div>
                ...
                %>
                    <div class="empty-state" style="grid-column: 1 / -1;">
                        ...
                        <button class="btn btn-primary" onclick="openAddModal()">Add Your First Room</button>
                    </div>
                <% } %>
            </div>
        </div>
    ...
    <div class="modal-overlay" id="roomModal">
        <div class="modal-card">
            ...
            <form class="modal-form" id="roomForm" method="post" action="${pageContext.request.contextPath}/room-servlet">
                <input type="hidden" name="action" id="formAction" value="add">
                <input type="hidden" name="id" id="roomId">
                
                <div class="form-group">
                    <label for="roomNumber">Room Number *</label>
                    <input type="text" id="roomNumber" name="roomNumber" required placeholder="e.g., 101, 202">
                </div>
        ...
        <div class="modal-card" style="text-align: center; max-width: 400px;">
            <div class="modal-header">
                ...
                <p style="color: rgba(255, 255, 255, 0.7); margin-top: 15px;">
                    Are you sure you want to delete <span id="deleteRoomNumber" style="color: #c9a55c;"></span>?
