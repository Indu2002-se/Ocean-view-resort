                ...
                <%@ page import="com.buddhi.oceanviewresort.service.*" %>
                    <%@ page import="com.buddhi.oceanviewresort.model.entity.*" %>
                        <% // Check if user is logged in
                            ...
                            String role=(String) session.getAttribute("role"); if (username==null) {
                            response.sendRedirect("login.jsp"); return; } long totalReservations=0; long
                            availableRooms=0; double monthlyRevenue=0.0; try {
                            totalReservations=ReservationService.getInstance().getAllReservations().size();
                            availableRooms=new RoomService().getAllRooms().stream().filter(r ->
                            ...
                            List<Bill> bills = BillService.getInstance().getAllBills();
                                ...
                                for (Bill b : bills) {
                                if (b.getIssueDate() != null && !b.getIssueDate().isBefore(startOfMonth)) {
                                ...
                                String monthlyRevenueFormatted = String.format("$%.2f", monthlyRevenue);
                                %>
                                <!DOCTYPE html>
                                <html lang="en">
                                    ...
                                    <main class="main-content">
                                        ...
                                        <div class="dashboard-content">
                                            ...
                                            <div class="welcome-banner">
                                                ...
                                                <div class="welcome-subtext">Here's what's happening at Ocean View
                                                    Resort today</div>
                                            </div>
                                                ...
                                                <div class="stat-card">
                                                    <div class="stat-header">
                                                        <div>
                                                            ...
                                                            <div class="stat-change">Live Availability</div>
                                                        </div>
                                                        <div class="stat-icon">🏨</div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="stat-card">
                                                    <div class="stat-header">
                                                        <div>
                                                            ...
                                                            <div class="stat-change">Current Month (<%=
                                            ...
                                            <div class="recent-activity">
                                                <div class="section-header">
                                                    ...
                                                    <a href="reservations.jsp"
                                                        style="color: #c9a55c; font-size: 12px; text-decoration: none;">View
                                                        All →</a>
                                                </div>
                                                <div class="activity-list">
                                                    <div class="activity-item">
                                                        ...
                                                        <div class="activity-details">
                                                            <div class="activity-title">New reservation created -
                                                                RES-2026-001</div>
                                                    ...
                                                    <div class="activity-item">
                                                        <div class="activity-icon">✅</div>
                                                        <div class="activity-details">
                                                            <div class="activity-title">Guest checked in - John Smith
                                                                (Deluxe Suite)
                                                            </div>
                                                    ...
                                                    <div class="activity-item">
                                                        <div class="activity-icon">💰</div>
                                                        <div class="activity-details">
                                                            <div class="activity-title">Payment received - RES-2026-045
                                                                ($450.00)</div>
                                                    ...
                                                    <div class="activity-item">
                                                        <div class="activity-icon">🚪</div>
                                                        <div class="activity-details">
                                                            <div class="activity-title">Guest checked out - Sarah
                                                                Johnson</div>
                                                    ...
                                                    <div class="activity-item">
                                                        <div class="activity-icon">⏰</div>
                                                        <div class="activity-details">
                                                            <div class="activity-title">Reservation pending confirmation
                                                                - RES-2026-002
                                                            </div>
